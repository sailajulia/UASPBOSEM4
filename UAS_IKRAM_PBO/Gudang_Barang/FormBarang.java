...
public class FormBarang extends JFrame {
    ...
    void simpanData(Table_Barang B) {
        try {
            String sql = "INSERT INTO table_barang (Kode_Barang, Nama_Barang, Harga_Barang, Stok_Barang) VALUES (?, ?, ?, ?)";
    ...
    void ubahData(Table_Barang B, String kode) {
        try {
    ...
    private void btAddAksi(ActionEvent evt) {
        Table_Barang B = new Table_Barang();
